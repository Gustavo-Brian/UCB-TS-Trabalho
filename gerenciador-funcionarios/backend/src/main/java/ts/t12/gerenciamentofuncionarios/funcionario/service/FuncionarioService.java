package ts.t12.gerenciamentofuncionarios.funcionario.service;
...
import ts.t12.gerenciamentofuncionarios.funcionario.repository.FuncionarioRepository;
...
public class FuncionarioService {
    ...
    public ConsultarFuncionarioResponse consultarPorEmail(String email) {
        ...
        return repository.findByEmail(email)
                .map(ConsultarFuncionarioResponse::converter)
                .orElse(null);
    }
    ...
    public ConsultarFuncionarioResponse cadastrar(CadastrarFuncionarioRequest request) {
        return ConsultarFuncionarioResponse.converter(
                repository.save(CadastrarFuncionarioRequest.converter(request))
        );
    }
